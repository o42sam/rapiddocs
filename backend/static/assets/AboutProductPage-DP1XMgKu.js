import{r as e}from"./index-CqQJt02h.js";class s{render(){const t=document.getElementById("app");t&&(t.innerHTML=`
    ...
    `,this.attachEventListeners())}attachEventListeners(){const t=document.getElementById("back-home-btn");t&&t.addEventListener("click",()=>{e.navigate("/")})}}export{s as AboutProductPage};
