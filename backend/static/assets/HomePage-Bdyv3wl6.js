var c=Object.defineProperty;var d=(r,e,t)=>e in r?c(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var o=(r,e,t)=>d(r,typeof e!="symbol"?e+"":e,t);import{r as n}from"./index-Dwqr2h1J.js";class h{constructor(){o(this,"element");o(this,"typingTimeout");this.element=document.createElement("section"),this.render(),this.attachEventListeners()}render(){this.element.className="hero-bg-wrapper pt-16",this.element.innerHTML=`
      <!-- Background image -->
    ...
    `}attachEventListeners(){const e=this.element.querySelector("#generate-now-btn");e&&e.addEventListener("click",()=>{n.navigate("/generate")}),setTimeout(()=>{this.startTypingAnimation()},300)}startTypingAnimation(){const e="Transform Your Ideas Into Professional Documents",t=this.element.querySelector("#typing-text");if(!t)return;let s=0;const a=()=>{s<e.length?(t.textContent=e.substring(0,s+1),s++,this.typingTimeout=window.setTimeout(a,50)):t.classList.remove("typing-active")};a()}mount(e){e.appendChild(this.element)}unmount(){this.typingTimeout&&clearTimeout(this.typingTimeout),this.element.remove()}getElement(){return this.element}}class m{constructor(e={}){o(this,"observer");o(this,"elements",new Set);const{threshold:t=.1,rootMargin:s="0px 0px -100px 0px",onIntersect:a}=e;this.observer=new IntersectionObserver(l=>{l.forEach(i=>{i.isIntersecting&&(i.target.classList.add("is-visible"),a&&a(i))})},{threshold:t,rootMargin:s})}observe(e){this.elements.has(e)||(this.elements.add(e),e.classList.add("fade-in-bottom"),this.observer.observe(e))}unobserve(e){this.elements.has(e)&&(this.elements.delete(e),this.observer.unobserve(e))}disconnect(){this.observer.disconnect(),this.elements.clear()}}function v(){const r=new m({threshold:.1,rootMargin:"0px 0px -50px 0px"});return document.querySelectorAll("[data-animate]").forEach(e=>{r.observe(e)}),r}class p{constructor(){o(this,"hero");this.hero=new h}render(){const e=document.getElementById("app");if(!e)return;e.innerHTML=`
    ...
    `;const t=document.getElementById("hero-container");t&&this.hero.mount(t),v(),this.attachFooterLinkHandlers()}attachFooterLinkHandlers(){document.querySelectorAll(".footer-link").forEach(t=>{t.addEventListener("click",s=>{s.preventDefault();const a=s.currentTarget.getAttribute("href");a&&n.navigate(a)})})}renderFeatureCard(e,t,s,a){return`
    ...
    `}destroy(){this.hero.unmount()}}export{p as HomePage};
