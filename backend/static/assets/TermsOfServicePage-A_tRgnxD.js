class o{render(){const e=document.getElementById("app");if(!e)return;e.innerHTML=`
    ...
    `;const t=e.querySelector('a[href="/"]');t&&t.addEventListener("click",i=>{i.preventDefault();const{router:s}=require("../router");s.navigate("/")})}destroy(){}}export{o as TermsOfServicePage};
