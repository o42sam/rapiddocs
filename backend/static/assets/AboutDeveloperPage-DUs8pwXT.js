import{r as t}from"./index-CLOizYH_.js";class s{render(){const e=document.getElementById("app");e&&(e.innerHTML=`
    ...
    `,this.attachEventListeners())}attachEventListeners(){const e=document.getElementById("back-home-btn");e&&e.addEventListener("click",()=>{t.navigate("/")})}}export{s as AboutDeveloperPage};
