import{r as e}from"./index-Dwqr2h1J.js";class l{render(){const t=document.getElementById("app");t&&(t.innerHTML=`
            ...
            <div class="bg-white rounded-xl shadow-lg p-8">
              ...
              <ul class="space-y-4 mb-8">
                <li class="flex items-start">
                  ...
                  <span class="text-gray-600">5 documents/month</span>
                </li>
                <li class="flex items-start">
                  <svg class="w-5 h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                ...
                <li class="flex items-start">
                  ...
                  <span class="text-gray-600">Standard quality</span>
                </li>
                <li class="flex items-start">
                  <svg class="w-5 h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
            ...
            <div class="bg-white rounded-xl shadow-lg ring-2 ring-primary-600 transform scale-105 p-8">
              ...
              <ul class="space-y-4 mb-8">
                ...
                <li class="flex items-start">
                  ...
                  <span class="text-gray-600">All templates</span>
                </li>
                <li class="flex items-start">
                  <svg class="w-5 h-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
          ...
          <div class="mt-20 max-w-3xl mx-auto">
            ...
            <div class="space-y-6">
              ...
              <div class="bg-white rounded-lg shadow p-6">
                ...
                <p class="text-gray-600">We accept all major credit cards, PayPal, and wire transfers for enterprise customers.</p>
              </div>
              <div class="bg-white rounded-lg shadow p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-2">Is there a free trial?</h3>
                <p class="text-gray-600">Yes! Our Free plan lets you generate up to 5 documents per month at no cost. Upgrade anytime for unlimited access.</p>
              </div>
            </div>
          </div>
    ...
    `,this.attachEventListeners())}attachEventListeners(){const t=document.getElementById("back-home-btn");t&&t.addEventListener("click",()=>{e.navigate("/")})}}export{l as PricingPage};
