var n=Object.defineProperty;var d=(t,e,s)=>e in t?n(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var a=(t,e,s)=>d(t,typeof e!="symbol"?e+"":e,s);import{r as c}from"./index-CLOizYH_.js";class h{constructor(){a(this,"element");this.element=document.createElement("section"),this.render(),this.attachEventListeners()}render(){this.element.className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 pt-16",this.element.innerHTML=`
    ...
    `}attachEventListeners(){const e=this.element.querySelector("#generate-now-btn");e&&e.addEventListener("click",()=>{c.navigate("/generate")})}mount(e){e.appendChild(this.element)}unmount(){this.element.remove()}getElement(){return this.element}}class v{constructor(e={}){a(this,"observer");a(this,"elements",new Set);const{threshold:s=.1,rootMargin:o="0px 0px -100px 0px",onIntersect:r}=e;this.observer=new IntersectionObserver(l=>{l.forEach(i=>{i.isIntersecting&&(i.target.classList.add("is-visible"),r&&r(i))})},{threshold:s,rootMargin:o})}observe(e){this.elements.has(e)||(this.elements.add(e),e.classList.add("fade-in-bottom"),this.observer.observe(e))}unobserve(e){this.elements.has(e)&&(this.elements.delete(e),this.observer.unobserve(e))}disconnect(){this.observer.disconnect(),this.elements.clear()}}function m(){const t=new v({threshold:.1,rootMargin:"0px 0px -50px 0px"});return document.querySelectorAll("[data-animate]").forEach(e=>{t.observe(e)}),t}class g{constructor(){a(this,"hero");this.hero=new h}render(){const e=document.getElementById("app");if(!e)return;e.innerHTML=`
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="md:col-span-1">
              <div class="flex items-center mb-4">
                <img src="/logo.png" alt="RapidDocs Logo" class="h-8 w-8 mr-2">
    ...
    `;const s=document.getElementById("hero-container");s&&this.hero.mount(s),m()}renderFeatureCard(e,s,o,r){return`
      <div class="bg-white p-6 rounded-xl shadow-lg card-hover" data-animate>
        <div class="w-12 h-12 bg-${r}-100 rounded-lg flex items-center justify-center mb-4">
          <svg class="w-6 h-6 text-${r}-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    `}destroy(){this.hero.unmount()}}export{g as HomePage};
